...
namespace DragDropBetweenControls
{
    public class OrderInfoCollection : IDisposable
    {
        ...
        {
            // Create two collections with 10 records each and specific starting OrderIDs
            var repo = new OrderInfoRepository();
            Collection1 = repo.GetListOrdersDetails(18, 1001);
            Collection2 = repo.GetListOrdersDetails(18, 101);
        }

        /// <summary>
        /// First collection bound to sfDataGrid1
        /// </summary>
        public ObservableCollection<OrderInfo> Collection1 { get; set; }

        /// <summary>
        /// Second collection bound to sfDataGrid2
        /// </summary>
        public ObservableCollection<OrderInfo> Collection2 { get; set; }
    ...
    public class OrderInfoRepository
    {
        ...
        /// <returns></returns>
        public ObservableCollection<OrderInfo> GetListOrdersDetails(int count, int startId)
        {
            var ordersDetails = new ObservableCollection<OrderInfo>();
            if (ShipCity.Count == 0)
                SetShipCity();
